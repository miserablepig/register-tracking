...
if( isset($_POST) ){
	...
	if($formok){
	insert("INSERT INTO tbCourses (Title, Type_ID, Date_Info, Time_Info, Contact_ID, Location_ID, Trainer_ID) VALUES ( '".$course_title."' , '".$course_type_id."' , '".$course_date_info."' , '".$course_time_info."' , '".$course_contact_id."' , '".$course_location_id."' , '".$course_trainer_id."')");
	}
